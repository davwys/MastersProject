...
class Adafruit_PN532{
 public:
  ...
  Adafruit_PN532(uint8_t clk, uint8_t miso, uint8_t mosi, uint8_t ss, CyMCP23016 expander);  // Software SPI with expander
  Adafruit_PN532(uint8_t irq, uint8_t reset);  // Hardware I2C
  Adafruit_PN532(uint8_t ss);  // Hardware SPI
  void begin(void);
  void begin(CyMCP23016 expander);
  ...
  // ISO14443A functions
  bool readPassiveTargetID(uint8_t cardbaudrate, uint8_t * uid, uint8_t * uidLength, uint16_t timeout = 50); //timeout 0 means no timeout - will block forever.
  bool readPassiveTargetID(uint8_t cardbaudrate, uint8_t * uid, uint8_t * uidLength, CyMCP23016 expander, uint16_t timeout = 50); //timeout 0 means no timeout - will block forever.
  ...
  uint8_t ntag2xx_ReadPage (uint8_t page, uint8_t * buffer, CyMCP23016 expander);
