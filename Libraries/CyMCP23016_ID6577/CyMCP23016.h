...
public:
    ...
    */
    ...
    /**
     * Initializes the MCP23016 at the given address and attach
     * to the specified SDA/SCL pins. This method should be used
     * for boards that share pins with SDA/SCL (such as ESP* boards).
     * @param sda The GPIO pin to use for SDA.
    ...
    /**
     * Initializes the MCP23016 at the default address and attach
     * to the specified SDA/SCL pins. This method should be used
     * for boards that share pins with SDA/SCL (such as ESP* boards).
     * @param sda The GPIO pin to use for SDA.
     * @param scl The GPIO pin to use for SCL.
